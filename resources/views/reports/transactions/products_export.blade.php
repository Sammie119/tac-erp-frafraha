<form method="POST" action="products_export_report">
    @csrf
...
{{--        </div>--}}
        ...
        <div class="col-md-12">
            <label for="select" class="form-label">{{ __('Select Category') }}</label>
            <x-input-select :options="$categories" :selected="0" name="category" required />
